...
public class PersonController {
    ...
    @Operation(summary = "Finds All People", description = "Finds All Aeople", tags = {"People"},
    responses = {
    ...
    @Operation(summary = "Deletes a new Person",
            description = "Deletes a new Personby passing in a Json, Xml or Yml representation of the person!",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
